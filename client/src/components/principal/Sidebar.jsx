...
const sidebarLinks = [
  ...
  { to: '/principal/attendance', label: 'Attendance', icon: '📋' },
  { to: '/principal/marks', label: 'Marks', icon: '📝' },
  { to: '/principal/timetable', label: 'Timetable', icon: '🗓️' },
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-xl shadow-lg shadow-violet-500/20">
              🎓
            </div>
            <div>
              <span className="text-lg font-bold text-white tracking-tight block leading-tight">EdTech</span>
              <span className="text-[11px] text-slate-500 font-medium uppercase tracking-wider">Admin Panel</span>
            </div>
          </div>
          <button
            onClick={() => setIsOpen(false)}
