      ...
      <div className="flex items-center justify-between px-6 lg:px-8 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-base shadow-sm">
              🎓
            </div>
            <div>
              <h2 className="text-sm lg:text-base font-bold text-white leading-tight">EdTech Institute</h2>
              <p className="text-[10px] text-slate-500 leading-none mt-0.5">Admin Management System</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="relative w-10 h-10 rounded-xl bg-slate-800/60 hover:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-white transition-colors">
            ...
            <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-violet-500 rounded-full text-[10px] text-white flex items-center justify-center font-bold">
              3
            </span>
          </button>
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-slate-800">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-sm font-bold text-white shadow-lg shadow-violet-500/20 select-none">
              {user?.name?.charAt(0)?.toUpperCase() || 'P'}
            </div>
            <div className="hidden sm:block">
              <p className="text-sm font-medium text-white leading-tight">{user?.name || 'Principal'}</p>
