...
const PrincipalNotices = () => {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      setDeletingId(null);
      // If we delete the last notice on the current page, go to the previous page
      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500">Announce updates, guidelines, or events to staff and students</p>
          </div>
              ...
              <form onSubmit={handlePost} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white placeholder-slate-600 focus:outline-none focus:border-violet-500 transition-colors resize-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-white focus:outline-none focus:border-violet-500 transition-colors"
                    >
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full mt-2 py-3 px-4 bg-violet-600 hover:bg-violet-700 disabled:bg-violet-800 text-white font-medium rounded-xl text-sm transition-colors shadow-lg shadow-violet-500/20"
                >
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-slate-900/50 border border-dashed border-slate-800 rounded-2xl text-center">
                  ...
                  <p className="text-slate-400 text-sm font-semibold">No notices posted yet</p>
                  <p className="text-slate-600 text-xs mt-1">Notices posted by the principal will appear here.</p>
                </div>
              ) : (
                <>
